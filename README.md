...
1) Clone the DPFFusion repository to your local machine (skip if already cloned):
...
2) Ensure the pre-trained model model-1_1_10_1.pth is placed in the ./models directory (as provided in your project).

3) Build the Docker image using the Dockerfile (replace dpffusion:v1 with your preferred image name/tag):
